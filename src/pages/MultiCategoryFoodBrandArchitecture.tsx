...
import foodbrandarchitecture from "/assets/Magsmen_Multi_Category_Food_Brand_Report.pdf"
...
export default function  FoodBrandArchitecture() {
 ...
 const handleLogin = async (e: FormEvent<HTMLFormElement>) => {
  ...
  try {
    ...
    setTimeout(() => {
      setIsLoggedIn(true);
      window.open(foodbrandarchitecture, '_blank');
    }, 800);
