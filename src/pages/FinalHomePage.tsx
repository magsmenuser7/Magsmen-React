...
.stmt-w300{font-family:'Montserrat',sans-serif;font-weight:300;font-size:clamp(1.9rem,4.8vw,4rem);color:rgba(255,255,255,.36);letter-spacing:-.02em;display:block}
.stmt-w300i{font-family:'Montserrat',sans-serif;font-weight:300;font-style:italic;font-size:clamp(1.9rem,4.8vw,4rem);color:rgba(255,255,255,.32);letter-spacing:-.01em;display:block}
.stmt-w900{font-family:'Montserrat',sans-serif;font-weight:900;font-size:clamp(2.2rem,5.8vw,5rem);color:#FFFFFF;letter-spacing:-.04em;display:block}
...
.lbl.wh{color:rgba(255,255,255,.32)}.lbl.wh::before{background:rgba(255,255,255,.18)}
...
.hero-tag{font-size:11px;font-weight:300;letter-spacing:.2em;text-transform:uppercase;color:rgba(255,255,255,.28);margin-bottom:2rem;display:flex;align-items:center;gap:10px}
.hero-tag::before{content:'';width:24px;height:1px;background:rgba(255,255,255,.25);flex-shrink:0}
...
.hs-l{font-size:11px;font-weight:300;letter-spacing:.06em;text-transform:uppercase;color:rgba(255,255,255,.27);display:block;margin-top:5px}
...
/* ── SERVICE CARDS ───────────────────────────────────────────────────────────── */
.sc{border:1px solid #EBEBEB;border-radius:7px;padding:2.25rem;transition:border-color .2s,transform .2s,box-shadow .2s;background:#FFF;position:relative}
...
/* ── PROCESS ─────────────────────────────────────────────────────────────────── */
.hww-item{display:grid;grid-template-columns:1fr;gap:.65rem;padding:2.5rem 0;border-bottom:1px solid #EBEBEB}
.hww-item:first-child{border-top:1px solid #EBEBEB}
.hww-n{font-size:11px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:#CCC}
...
.f-desc{font-size:15px;color:rgba(255,255,255,.3);line-height:1.85;max-width:470px;font-weight:300}
.f-cert{margin-top:1.5rem;display:flex;flex-direction:column;gap:.45rem}
.f-cert span{font-size:11px;color:rgba(255,255,255,.22);font-weight:300}
.fh{font-size:10px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:rgba(255,255,255,.2);margin-bottom:1rem}
.f-ul{list-style:none;display:flex;flex-direction:column;gap:.55rem}
.f-ul a{font-size:13px;font-weight:300;color:rgba(255,255,255,.38);cursor:pointer}
    ...
    <div className={`preloader${done?" done":""}`}>
      ...
      <div style={{ display:"flex", gap:"3px", alignItems:"center" }}>
        {"MAGSMEN".split("").map((l, i) => (
          <span key={i} className="pre-letter" style={{ animationDelay:`${1.0 + i * 0.075}s`, fontFamily:"'Montserrat',sans-serif", fontSize:"1.4rem", fontWeight:800, letterSpacing:".12em", color:"#FFF" }}>
            {l}
          </span>
        ))}
      </div>
    ...
    <>
      ...
      {mob && (
        <div className="mob-menu">
          ...
          <a className="mob-cta" href="mailto:connect@magsmen.com?subject=I want to discuss my situation">Talk to us →</a>
        </div>
      )}
    </>
  )
  ...
  return (
    <footer>
      <div className="fi">
        ...
        <div className="f-bot">
          <div className="f-copy">© 2025 Magsmen Strategy Consultants · Grofessors Innovations Pvt Ltd · Guntur, Andhra Pradesh</div>
  ...
  return (
    <div ref={ref} className="pg page-anim">
            ...
            <div style={{overflow:"hidden",marginBottom:"3rem",marginLeft:"-56px",paddingLeft:"56px"}}>
              <div style={{display:"flex",gap:"2.5rem",animation:"cbscroll 28s linear infinite",width:"max-content",paddingBottom:"4px"}}>
                {["FMCG","Real Estate","Healthcare","Media","Technology","Agriculture","Government","Retail","Education","Professional Services","Manufacturing","Financial Services","FMCG","Real Estate","Healthcare","Media","Technology","Agriculture","Government","Retail","Education","Professional Services","Manufacturing","Financial Services"].map((s,i)=>(
                  <span key={i} style={{fontSize:"11px",fontWeight:700,letterSpacing:".16em",textTransform:"uppercase",color:"rgba(255,255,255,.22)",whiteSpace:"nowrap"}}>{s}</span>
                ))}
              </div>
            </div>
          <div className="brow">
      ...
      <div className="sec sec-dark">
        <div className="si">
          <div className="crisis rv">
            ...
            <div>
              <div style={{fontSize:"11px",fontWeight:300,letterSpacing:".1em",textTransform:"uppercase",color:"rgba(255,255,255,.28)",marginBottom:"1.25rem"}}>Situations we address urgently</div>
      ...
      <div style={{background:"#0A0A0A",padding:"2rem 56px",textAlign:"center"}}>
        <div style={{fontSize:"1rem",fontWeight:300,fontStyle:"italic",color:"rgba(255,255,255,.42)",marginBottom:".35rem"}}>
          "Mana brand strong ga undali ante, first ga mana foundation strong ga undali."
        </div>
        <div style={{fontSize:".85rem",fontWeight:300,color:"rgba(255,255,255,.22)"}}>For our brand to be strong, first our foundation must be strong.</div>
      </div>
