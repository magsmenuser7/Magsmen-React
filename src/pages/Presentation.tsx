...
export default function  MagsmenPresentation() {
...
if (!isLoggedIn) {
  ...
  >
    ...
    <iframe
      src={`${magsmenpresentation}#toolbar=0&navpanes=0&scrollbar=0&view=FitH&zoom=page-width`}
      className="w-full h-full border-0"
      title="Magsmen Presentation"
    />
  </div>
    );
  }
