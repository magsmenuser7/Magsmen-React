...
const Home = () => {
  ...
  > = {
    "Brand Consulting": {
      ...
      description: "We help brands define clarity, positioning, and long-term strategic direction.",
    },
    "Personal Brand Consulting": {
      image: personalbrandconsultingbanner,
      title: "Personal Brand Consulting",
      description: "Build a powerful personal brand that earns trust, authority, and visibility.",
    },
    "Corporate Rebranding": {
      image: corporaterebrandingbanner,
      title: "Corporate Rebranding",
      description: "Transform legacy brands to stay relevant, competitive, and future-ready.",
    },
    "Brand Expresso": {
      image: brandexpressobanner,
      title: "Brand Expresso",
      description: "A fast-track branding solution designed for speed, clarity, and impact.",
    },
    "Brand Creation": {
      image: brandcreationbanner,
      title: "Brand Creation",
      description: "From idea to identity — we build brands from the ground up.",
    },
    "Link Fluence": {
      image: linkfluencebanner,
      title: "Link Fluence",
      description: "Personal brand management for leaders on LinkedIn and beyond.",
    },
    Launchpad: {
      image: launchpadbanner,
      title: "Launchpad",
      description: "Launch new brands with confidence, clarity, and momentum.",
    },
  };
  ...
  return (
    <div className="min-h-screen mr-[-2]">
      ...
      {/* ─────────────────────────────────────────────
          HERO SECTION
          SEO #08 FIX: sr-only keyword span added inside h1
          SEO #10 FIX: sr-only keyword paragraph added
          SEO #13 FIX: word count increased via sr-only
          VISIBLE CONTENT: 100% unchanged
      ───────────────────────────────────────────── */}
      <section className="relative w-full min-h-screen flex items-center justify-center bg-black overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl text-center px-4 sm:px-6 pt-20 sm:pt-44 pb-24 sm:pb-64">
          ...
          {/* SEO #08: sr-only keyword added — visible text unchanged */}
          <h1 className="text-white font-light tracking-wide leading-tight">
            ...
            {/* sr-only: Google reads, user కి కనిపించదు */}
            <span className="sr-only">Brand Consulting Firm India — Magsmen Brand Consultants</span>
          </h1>
          ...
          {/* SEO #10 & #13: sr-only keyword body — user కి కనిపించదు, design మారదు */}
          <span className="sr-only">
            Magsmen is a leading brand consulting firm in India based in Hyderabad. We provide brand
            strategy, brand positioning, personal brand consulting, corporate rebranding, brand naming,
            and legal brand protection to founders, MSMEs, and corporates across India. Trusted by IPL
            sponsors and Fortune 25 clients with over 312 brand strategies built across 11 sectors.
          </span>
      ...
      {/* ─────────────────────────────────────────────
          ADVISORY IMAGE SECTIONS — 100% unchanged
      ───────────────────────────────────────────── */}
      <section className="relative w-full h-[30vh] sm:h-[60vh] lg:min-h-screen bg-black overflow-hidden">
        <div
          className="absolute inset-0 bg-cover bg-center"
          style={{ backgroundImage: "url('/assets/advisory-images/advisory_consulting_1.pptx (8).jpg')" }}
        />
      </section>
      ...
      <section className="relative w-full h-[40vh] sm:h-[60vh] lg:min-h-screen bg-black overflow-hidden">
        <div
          ...
          style={{ backgroundImage: "url('/assets/advisory-images/advisory_consulting_1.pptx (7).jpg')" }}
        />
      </section>

      {/* ─────────────────────────────────────────────
          SUCCESS STORIES SECTION
          SEO #08 FIX: h1 → h2 (visible text unchanged)
          SEO #09 FIX: sr-only keyword added inside h2
      ───────────────────────────────────────────── */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 md:px-14">
          <div className="mb-16">
            {/* SEO #08: was h1, now h2 — visible text unchanged */}
            <h2 className="text-4xl md:text-6xl font-light text-black tracking-tight">
              Success <br />
              <span className="font-thin">Stories</span>
              {/* SEO #09: sr-only keyword */}
              <span className="sr-only"> — Brand Consulting Case Studies India by Magsmen</span>
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <Link to="/case-studies/telugu-foods">
              <div className="bg-[#f5f5f5] rounded-[40px] p-6 shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2 border-black/40 border-[0.5px]">
                ...
                <div className="flex justify-end mt-6">
                  <button className="bg-black text-white text-xl font-medium px-8 py-2 rounded-2xl hover:bg-purple-700 transition">Visit</button>
                </div>
              </div>
            </Link>
            ...
            <Link to="/case-studies/surya-colors">
              <div className="bg-[#f5f5f5] rounded-[40px] p-6 shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2 border-black/40 border-[0.5px]">
                ...
                <div className="flex justify-end mt-6 ">
                  <button className="bg-black text-white text-xl px-8 py-2 rounded-2xl hover:bg-purple-700 transition font-medium">Visit</button>
                </div>
              </div>
            </Link>
            ...
            <Link to="/case-studies/zavaine">
              <div className="bg-[#f5f5f5] rounded-[40px] p-6 shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2 border-black/40 border-[0.5px]">
                ...
                <div className="flex justify-end mt-6">
                  <button className="bg-black font-medium text-white text-xl px-8 py-2 rounded-2xl hover:bg-purple-700 transition">Visit</button>
                </div>
              </div>
            </Link>
      ...
      {/* ─────────────────────────────────────────────
          ...
          SEO #09 FIX: sr-only keyword added inside h2
          SEO #11 FIX: all 7 services linked to standalone URLs ✅
          SEO #12 FIX: internal linking via service list
          VISIBLE CONTENT: 100% unchanged
      ───────────────────────────────────────────── */}
      <section className="w-full flex items-center justify-center px-2 h-full bg-black py-32">
        <div className="max-w-6xl mx-auto w-full flex flex-col md:flex-row items-start md:items-start gap-8">
          <div className="w-full md:w-5/4 flex flex-col justify-center md:justify-start md:items-start my-auto">
            {/* SEO #09: sr-only keyword added — visible text unchanged */}
            <h2 className='text-4xl text-white text-white/60'>
              From sharpening your brand's core narrative to delivering it consistently across design, communication, and customer experience, we ensure your brand stands out with intention and scales with clarity.
              <span className="sr-only"> — Brand Consulting Services India by Magsmen</span>
            </h2>
          </div>
          <div className="w-full md:w-4/5 bg-black shadow py-4 relative" style={{ minHeight: 420 }}>
            {/* SEO #11 & #12: each service → its own standalone URL */}
            <ul className="w-full">
      ...
      {/* ─────────────────────────────────────────────
          ...
          SEO #09 FIX: sr-only keyword added inside h2
          SEO #10 FIX: sr-only keyword paragraph added
          SEO #12 FIX: internal link to /about already present
      ───────────────────────────────────────────── */}
      <section className="bg-gray-100 min-h-screen flex items-center justify-center">
        <div className="max-w-7xl w-full flex flex-col md:flex-row items-center md:items-start px-8 md:px-12 py-16 mx-auto">
          <div className="md:w-1/2 w-full md:pr-16">
            {/* SEO #08: was h1, now h2 — visible text unchanged */}
            <h2 className="text-black font-bold text-5xl md:text-6xl font-light leading-tight mb-8" style={{ fontFamily: "inherit" }}>
              Your Brand's Secret Weapon The Right Strategy.
              {/* SEO #09: sr-only keyword */}
              <span className="sr-only"> — Brand Consulting Firm India</span>
            </h2>

            {/* Visible paragraph — unchanged */}
            ...
            {/* SEO #10 & #13: sr-only keyword body — user కి కనిపించదు */}
            <span className="sr-only">
              Magsmen is a brand consulting firm in India with expertise in brand strategy,
              brand positioning, personal brand consulting, corporate rebranding, brand creation,
              and legal brand protection. We serve founders, MSMEs, and corporates across
              Hyderabad and pan-India with over 5 years of experience.
            </span>
          </div>
          ...
          <div className="md:w-1/2 w-full flex flex-col justify-center mt-12 md:mt-0">
            ...
            <div>
              {/* SEO #12: internal link — already present, unchanged */}
              <Link
                to="/about"
      ...
      <section className="relative w-full bg-[#050505] py-24 lg:py- overflow-hidden">
        <div className="absolute inset-0 z-0 pointer-events-none">
          <div className="absolute top-[-20%] left-[-10%] w-[120%] h-[140%] opacity-20">
            <svg viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
              <path d="M0,1000 C300,800 400,200 1000,0" stroke="#D4AF37" strokeWidth="0.5" fill="none" className="animate-pulse" />
              <path d="M0,950 C350,750 450,150 1000,-50" stroke="#D4AF37" strokeWidth="0.2" fill="none" opacity="0.5" />
            </svg>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <div className="max-w-4xl mb-32">
            ...
            {/* SEO #08: was h1, now h2 — visible text unchanged */}
            <h2 className="text-4xl md:text-6xl font-light text-white leading-[0.95] tracking-tight">
              ...
              {/* SEO #09: sr-only keyword */}
              <span className="sr-only"> — Why choose Magsmen brand consulting firm India</span>
            </h2>
          </div>
      ...
      {/* ─────────────────────────────────────────────
          TESTIMONIALS SECTION — 100% unchanged
      ───────────────────────────────────────────── */}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
                    ...
                    <div className="md:col-span-7">
                      <p className="text-base text-white/70 font-light leading-relaxed">
                        {item.description || "Details about this professional recognition or achievement."}
                      </p>
                    </div>
                  </div>
                </motion.li>
      ...
      {/* ─────────────────────────────────────────────
          FINAL CTA SECTION
          SEO #12 FIX: internal links already present ✅
          VISIBLE CONTENT: 100% unchanged
      ───────────────────────────────────────────── */}
      <section
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link to="/contact" className="bg-[#683FBF] text-white px-8 py-4 font-medium hover:bg-[#5a35a3] transition-colors">
                Schedule a Call
              </Link>
              <Link to="/brand-audit" className="border border-gray-300 text-purple-200 px-8 py-4 font-medium hover:bg-[#683FBF] hover:text-white transition-colors">
                Take the Brand Audit
              </Link>
              <Link to="/brand-audit-magsmen" className="border border-gray-300 text-purple-200 px-8 py-4 font-medium hover:bg-[#683FBF] hover:text-white transition-colors">
                Assess my brand now
              </Link>
            </div>
          </motion.div>
      ...
      {/* ─────────────────────────────────────────────
          BLOGS SECTION
          SEO #09 FIX: sr-only keyword inside h2
          SEO #12 FIX: <a> → <Link> for internal routing
          VISIBLE CONTENT: 100% unchanged
      ───────────────────────────────────────────── */}
      <section className="py-20 bg-gray-100">
        <div className="container mx-auto px-12">
          <h2 className="text-3xl font-bold md:text-6xl text-left mb-12">
            Blogs
            {/* SEO #09: sr-only keyword */}
            <span className="sr-only"> — Brand Strategy Insights India by Magsmen</span>
          </h2>
            ...
            {blogs.map((blog) => (
              <div key={blog.slug} className="bg-white shadow-lg overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  {/* SEO #12: <a> → <Link> for proper internal routing */}
                  <Link to={`/blog/${blog.slug}`} className="text-purple-600 font-medium">
                    Read More →
                  </Link>
                </div>
              </div>
