...
import annauladvisoryprogramme from "/assets/Magsmen_Annual_Advisory_Programme.pdf"
...
export default function  Kalanikethan() {
 ...
 const handleLogin = async (e: FormEvent<HTMLFormElement>) => {
  ...
  try {
    ...
    setTimeout(() => {
      setIsLoggedIn(true);
      window.open(annauladvisoryprogramme, '_blank');
    }, 800);
